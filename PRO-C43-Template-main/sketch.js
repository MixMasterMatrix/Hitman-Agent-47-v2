...
function preload() {
    ...
    missionPassed = loadImage("pics/mission passed.png");
    fireSound = loadSound("pics/gunshot sound.wav");
    failedSound = loadSound("pics/failed shot sound.wav");
    introImage = loadImage("pics/intro screen.jpg")
    introImage2 = loadImage("pics/intro screen 2.jpg")
    overImage = loadImage("pics/game over.jpg");
}
...
function draw() {
  ...
  if(gameState === "introScreen"){
    ...
    text("You are a secret agent who is hunting down various targets in the city", 1520/2, 625/2 - 200);
    text("who are suspected to be up to no good. Your job", 1520/2, 625/2 - 150) ;
    text("is to eliminate the targets, while not harming the citizens.", 1520/2, 625/2 - 100);
    text("This is a target.",900,340);
    text("This is a citizen.",900,500);
    text("Click Next to Move on to the First Mission, the City!", 1520/2, 625/2 + 325) ;

    imageMode(CENTER)
    image(targetImg1,450, 350, 150, 150);
    image(citizen1, 450, 500, 110, 150);

    stroke(255,255,255);
    strokeWeight(7);
    line(width/2,490,540,490)
    line(600,450,540,490);
    line(600,530,540,490);

    line(width/2,330,540,330)
    line(600,290,540,330);
    line(600,370,540,330);
  ...
  if(gameState === "introLevel2"){
    ...
    text("Click Next to Move on to the Second Mission, the Mall!", 1520/2, 625/2 + 50) ;
    imageMode(CENTER)
    image(missionPassed, width/2, 200, 550, 100);
  ...
  if(gameState === "introLevel3"){
    ...
    text("Click Next to Move on to the Third Mission, the Restaurant!", 1520/2, 625/2 + 50) ;
    imageMode(CENTER)
    image(missionPassed, width/2, 200, 550, 100);
  ...
  if(gameState === "introLevel4"){
    ...
    text("Click Next to Move on to the Fourth Mission, the Plane!", 1520/2, 625/2 + 50) ;
    imageMode(CENTER)
    image(missionPassed, width/2, 200, 550, 100);
  ...
  if(gameState === "introLevel5"){
    ...
    text("Click Next to Move on to the Final Mission, the Hotel!", 1520/2, 625/2 + 50) ;
    imageMode(CENTER)
    image(missionPassed, width/2, 200, 550, 100);
